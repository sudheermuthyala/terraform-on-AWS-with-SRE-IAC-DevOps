...
- **Resource Lable or Resource Local name** it is entair This resource Local Name is used to reffer this resource from elsewherw in the terraform modules but
