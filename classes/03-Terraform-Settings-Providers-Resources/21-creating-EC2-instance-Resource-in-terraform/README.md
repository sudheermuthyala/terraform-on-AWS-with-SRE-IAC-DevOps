...
- **Number of Lables-** for Resources have two block lables, and for varibles we have one block lable, based on the block type you will find sone thing number lables That Respective Block,what ever you define inside that blocks are called 
## BlockType
